...
{var registry=IWCreateEffectRegistry();registry.registerEffects({stroke_1:new IWStroke('About_me_files/stroke.png',new IWRect(-3,-3,707,10),new IWSize(700,5)),stroke_0:new IWEmptyStroke()});registry.applyEffects();}
function hostedOnDM()
{return false;}
function onPageLoad()
